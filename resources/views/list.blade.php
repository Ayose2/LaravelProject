...
@section('content')
  <input class="form-control mt-5" id="search" type="text" placeholder="Buscar producto..">
      ...
      <li class="list-group-item d-flex justify-content-between align-items-start">
        ...
        <div>
          ...
          <div class="mt-5">
            ...
            <a class="ml-2" href="/producto/remove/{{ $producto->id }}" data-toggle="tooltip" data-placement="top" title="Borrar producto"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>
          </div>
        </div>
